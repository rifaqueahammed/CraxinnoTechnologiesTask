    ...
    <div className="p-4 w-1/4 border h-screen flex flex-col gap-2">
      ...
      <div className="">
        <div className="flex gap-2">
          <label>Balance</label>
          <input className="p-1 border" onChange={(e)=>setBalance(e.target.value)}></input>
        </div>
        <button className="p-2 bg-gray-600 rounded-md text-white ml-2 mt-2" onClick={addUserAccount}>
          Submit
        </button>
      </div>
      <div>
